...
import app.reup.sync.AeadCipher
import app.reup.sync.CryptoErrorKind
import app.reup.sync.CryptoException
...
// COPY OF shared/src/jvmMain/.../JvmAeadCipher.kt, and that is worth saying out loud.
//
...
// source itself needs no change at all - javax.crypto and AES/GCM/NoPadding have been on Android since API 1.
//
...
//
// The line that must never drift from the original: TAG_BITS = 128, which is BITS.
